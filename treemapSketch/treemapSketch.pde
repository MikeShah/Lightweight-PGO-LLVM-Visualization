...
void setup() {
  ...
  myTreeMap.drawTreeMap(myTreeMap.root,0,0,width,height,0,4,4,10);
...
void draw() {
  ...
  if(keyIndex=='q'){
    myTreeMap.drawTreeMap(myTreeMap.root.children.get(0),0,0,width,height,0,2,0,10);
  }
  else if(keyIndex=='w'){
    myTreeMap.drawTreeMap(myTreeMap.root.children.get(0).children.get(1),0,0,width,height,0,2,0,10);
  }
  else if(keyIndex=='e'){
    myTreeMap.drawTreeMap(myTreeMap.root.children.get(2),0,0,width,height,0,2,0,10);
  }
  else{
    myTreeMap.drawTreeMap(myTreeMap.root,0,0,width,height,0,2,0,keyIndex);
  }
}
